...
You can import them from the `ipynb` file on your computer by using Colab's *Import notebook* feature, or you can open them directly by clicking these links:
